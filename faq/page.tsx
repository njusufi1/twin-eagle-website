...
export const metadata: Metadata = {
  title: "FAQ",
  description: "Answers about Twin Eagle Technologies services, the Coverage Guarantee, dedicated technicians, English proficiency, coverage hours, quality, and supported industries.",
};
